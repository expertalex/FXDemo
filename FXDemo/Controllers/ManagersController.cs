...
namespace FXDemo.Controllers
{
    public class ManagersController : Controller
    {
        ...
        {
            var fXDataContext = _context.Manager.Include(m => m.Team);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,YellowCards,RedCards,MinutesPlayed", "TeamId")] Manager manager)
        {
            if (id != manager.Id)
            {
                return NotFound();
